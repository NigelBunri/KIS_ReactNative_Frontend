...
const buildStyles = (palette: ReturnType<typeof useKISTheme>['palette']) => StyleSheet.create({
  ...
  headerTitle: { color: palette.secondary, fontSize: 18, fontWeight: '700' },
  backBtn: { paddingRight: 8 },
  backBtnText: { color: palette.secondary, fontSize: 14 },
  closeBtn: { padding: 8 },
  closeBtnText: { color: palette.secondary, fontSize: 18 },
  body: { flex: 1 },
