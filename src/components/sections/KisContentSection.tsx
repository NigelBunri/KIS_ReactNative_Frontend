...
export default function KisContentSection({ data, palette, typography, spacing, onFieldChange }: SectionRenderProps) {
  ...
  return (
    <View style={{ marginTop: spacing.md, borderRadius: spacing.sm, borderWidth: 1, borderStyle: 'dashed', borderColor: palette.divider, padding: spacing.md }}>
      <EditableText
        value={String(data?.heading || `Live ${targetType}`)}
        style={{ ...typography.h3, color: palette.text }}
        onChangeText={onFieldChange ? (v) => onFieldChange('heading', v) : undefined}
      />
