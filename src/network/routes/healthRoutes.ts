...
const healthRoutes = {
  ...
  core: {
    organizations: `${API_BASE_URL}/api/v1/medical/organizations/`,
    profiles: `${API_BASE_URL}/api/v1/medical/profiles/`,
    locations: `${API_BASE_URL}/api/v1/medical/locations/`,
    wards: `${API_BASE_URL}/api/v1/medical/wards/`,
    services: `${API_BASE_URL}/api/v1/medical/services/`,
    equipment: `${API_BASE_URL}/api/v1/medical/equipment/`,
    inventory: `${API_BASE_URL}/api/v1/medical/inventory/`,
    inventoryItem: (id: string) => `${API_BASE_URL}/api/v1/medical/inventory/${id}/`,
    diagnosticOrders: `${API_BASE_URL}/api/v1/medical/diagnostic-orders/`,
    diagnosticOrder: (id: string) => `${API_BASE_URL}/api/v1/medical/diagnostic-orders/${id}/`,
    imagingStudies: `${API_BASE_URL}/api/v1/medical/imaging/`,
    imagingStudy: (id: string) => `${API_BASE_URL}/api/v1/medical/imaging/${id}/`,
    adherenceReminders: `${API_BASE_URL}/api/v1/medical/adherence-reminders/`,
    adherenceReminder: (id: string) => `${API_BASE_URL}/api/v1/medical/adherence-reminders/${id}/`,
    adherenceMarkSent: (id: string) =>
      `${API_BASE_URL}/api/v1/medical/adherence-reminders/${id}/mark-sent/`,
    ...
    staffAssignRole: (id: string) => `${API_BASE_URL}/api/v1/medical/staff/${id}/assign-role/`,
    staffAssignShift: (id: string) => `${API_BASE_URL}/api/v1/medical/staff/${id}/assign-shift/`,
    staffAudits: `${API_BASE_URL}/api/v1/medical/staff-audits/`,
  },
  analytics: {
