...
export default function WebsitePreviewScreen({ route }: Props) {
  ...
  if (!previewUrl) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: palette.bg, alignItems: 'center', justifyContent: 'center', padding: spacing.lg }}>
